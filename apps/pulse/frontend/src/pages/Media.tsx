      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 12 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <select value={model} onChange={(e) => setModel(e.target.value)} style={inputStyle}>
            <option value="fast">Fast (~3 credits)</option>
            <option value="quality">Quality (~15 credits)</option>
            <option value="freepik">Freepik Mystic (~12 credits)</option>
          </select>
        </div>
      </div>
      ...
      {result && (
        <div style={{ textAlign: 'center', marginTop: 12, marginBottom: 12 }}>
          ...
          <p style={{ color: 'var(--accent)', fontSize: 13, marginTop: 8 }}>
            Saved to library — {result.creditsUsed} credits used
          </p>
        </div>
      )}
