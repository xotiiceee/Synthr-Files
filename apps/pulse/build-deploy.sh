...
cd frontend
pnpm install
VITE_CLERK_PUBLISHABLE_KEY="${VITE_CLERK_PUBLISHABLE_KEY:-${CLERK_PUBLISHABLE_KEY:-}}" pnpm build
cd ..
...
echo ""
echo "To drop on VPS:"
echo "  1. scp -r deploy/* user@vps:/home/deploy/pulse/"
echo "  2. On VPS: cd /home/deploy/pulse"
